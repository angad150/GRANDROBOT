...
TECHNO_IMG = "https://telegra.ph/file/d9f7b7598e6d92d61c339.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Nubster_noob")],
                                                                                   [InlineKeyboardButton(text="ADD Ananya pro bot TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Me already alive master 🙂😌😌")
